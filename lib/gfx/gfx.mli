...
val main_loop : (float -> 'a option) -> ('a -> unit) -> unit
(** [main_loop f k] calls a [f] repeteadly.
    - DSL : f is called as quickly as possible
    - JS : f is passed to [requestAnimationFrame] and is called no faster than 60 times/seconds.
